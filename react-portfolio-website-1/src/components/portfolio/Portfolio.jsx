    ...
    <section id='portfolio'>
      ...
      <div className="container portfolio__container">
        <article className="portfolio__item">
          ...
          <a href="https://github.com/CGlinka95/react-portfolio" className='btn btn-primary' target="_blank">GitHub</a>
        </article>
        <article className="portfolio__item">
          <div className="portfolio__item-image">
          ...
          <a href="https://github.com/CGlinka95/eBike-WebApp" className='btn' target="_blank">GitHub</a>
        </article>
        <article className="portfolio__item">
          <div className="portfolio__item-image">
          ...
          <a href="https://github.com/CGlinka95/CGs-Sudoku-Solver" className='btn btn-primary' target="_blank">GitHub</a>
        </article>
      </div>
    </section>
  )
